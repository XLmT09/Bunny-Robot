...
class SoundResponse implements Behavior {
	...
	public SoundResponse(BaseRegulatedMotor mLeft, BaseRegulatedMotor mRight, NXTSoundSensor us, float noise) {
		this.mLeft = mLeft;
		this.mRight = mRight;
		this.noise = noise + 0.2f; //this refers to a sound 0.2 above the average found
		this.us = us;
	...
	public boolean takeControl() {
		...
		return soundSample[0] > noise; //return true if noise found is 0.2 more than average sound observed
	}
